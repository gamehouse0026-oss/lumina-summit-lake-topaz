...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BhymvWcH.js
var router_BhymvWcH_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Cg5FqA9l.css";
var APP_NAME = "Lumina";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Unlimited media player with real-time SRT captions."
			},
			{
				name: "theme-color",
				content: "#09090b"
...
var $$splitComponentImporter = () => import("./routes-zF6gAY7a.mjs");
...
//#endregion
export { getRouter, router_BhymvWcH_exports as t };
