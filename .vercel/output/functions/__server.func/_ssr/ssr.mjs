...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dxb9r_lm.mjs");
...
var manifest = {
	"93d98280c9a9b384250e066ba9aaa3aa49c0d307c6c6b002a4cb0ab03e7107c0": {
		functionName: "getAiStatus_createServerFn_handler",
		importer: () => import("./transcribe-BsKZTLIi.mjs")
	},
	"a9ea6aa6844e8ad41c163c119ff6b3f7868f3fb568dd63af378eaebdd00561ae": {
		functionName: "transcribeAudio_createServerFn_handler",
		importer: () => import("./transcribe-BsKZTLIi.mjs")
	},
	"b7ba596e6924a251ee7b4ad7894da4335e29217f2ce0c5816b7bf9ea49d1b60b": {
		functionName: "translateCues_createServerFn_handler",
		importer: () => import("./translate-Qr3sGzIF.mjs")
	},
	"f709d63662aa300f4cf8f6ab9fcd685538601855c0bc7ea2450773b8bc2686f4": {
		functionName: "summarizeTranscript_createServerFn_handler",
		importer: () => import("./translate-Qr3sGzIF.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BhymvWcH.mjs").then((n) => n.t),
