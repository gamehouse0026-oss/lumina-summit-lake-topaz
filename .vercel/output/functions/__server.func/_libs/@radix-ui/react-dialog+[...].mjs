...
__name$9(useStateMachine, "useStateMachine");
var Presence = /* @__PURE__ */ __name$9((props) => {
...
function usePresence(present) {
	...
	useLayoutEffect2(() => {
		if (node) {
			...
			const handleAnimationEnd = /* @__PURE__ */ __name$9((event) => {
			...
			const handleAnimationStart = /* @__PURE__ */ __name$9((event) => {
...
__name$9(usePresence, "usePresence");
function setRef(ref, value) {
	if (typeof ref === "function") return ref(value);
	else if (ref !== null && ref !== void 0) ref.current = value;
}
__name$9(setRef, "setRef");
...
__name$9(useStableComposedRefs, "useStableComposedRefs");
function getAnimationName(styles) {
	return styles?.animationName || "none";
}
__name$9(getAnimationName, "getAnimationName");
...
__name$9(getElementRef, "getElementRef");
//#endregion
...
var DismissableLayer = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$7(function DismissableLayer2(props, forwardedRef) {
...
function usePointerDownOutside(onPointerDownOutside, args) {
	...
	import_react.useEffect(() => {
		...
		const handlePointerDown = /* @__PURE__ */ __name$7((event) => {
			if (event.target && !isPointerInsideReactTreeRef.current) {
				...
				__name$7(handleAndDispatchPointerDownOutsideEvent2, "handleAndDispatchPointerDownOutsideEvent");
	...
	return { onPointerDownCapture: /* @__PURE__ */ __name$7(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture") };
}
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis?.document) {
	...
	return {
		onFocusCapture: /* @__PURE__ */ __name$7(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
		onBlurCapture: /* @__PURE__ */ __name$7(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
	};
}
...
//#endregion
export { useLayoutEffect2 as _, DialogPortal as a, hideOthers as c, useId as d, FocusScope as f, Presence as g, useCallbackRef$1 as h, DialogOverlay as i, useControllableState as l, DismissableLayer as m, DialogClose as n, DialogTitle as o, useFocusGuards as p, DialogContent as r, ReactRemoveScroll as s, Dialog as t, Portal as u, Primitive as v };
